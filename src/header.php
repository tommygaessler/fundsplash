...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Fundsplash is a crowdfunding website where Unsplash photographers can raise money for their next adventure!">
    ...
    <header>
      <div class="wrapper">
        <div class="logo">
          ...
          <img src="images/unsplash.svg" alt=""/>
          <a href="http://tommygaessler.com" target="_blank"><img class="profilepicture" src="images/me.jpg" alt="" /></a>
          <h2><a href="index.php">Fundsplash</a></h2>
        </div>
      </div>
    </header>
